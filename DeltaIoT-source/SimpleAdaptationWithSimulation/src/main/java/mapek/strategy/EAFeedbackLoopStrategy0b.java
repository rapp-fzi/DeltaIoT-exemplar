...
class EAFeedbackLoopStrategy0b extends FeedbackLoop {

    private static int CHANGE_DIST_VALUE = 10; // original value from Paper: 10.0
    private static int UNIFORM_DIST_VALUE = 50;

    private final StrategyConfigurationEAStrategy0b config;

    public EAFeedbackLoopStrategy0b(SimulationClient networkMgmt, IMoteWriter moteWriter,
            StrategyConfigurationEAStrategy0b configuration) {
