...
class EAFeedbackLoopStrategy2a extends FeedbackLoop {
    ...
    private final StrategyConfigurationEAStrategy2a config;

    public EAFeedbackLoopStrategy2a(SimulationClient networkMgmt, IMoteWriter moteWriter,
            StrategyConfigurationEAStrategy2a configuration) {
    ...
    protected void initRun() {
        ...
        POWER_MAX[0] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[1] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[2] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[3] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[4] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[5] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[6] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[7] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[8] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[9] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[10] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[11] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[12] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[13] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[14] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[15] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
        POWER_MAX[16] = config.POWER_MIN + config.POWER_MIN_MAX_DELTA + 1;
