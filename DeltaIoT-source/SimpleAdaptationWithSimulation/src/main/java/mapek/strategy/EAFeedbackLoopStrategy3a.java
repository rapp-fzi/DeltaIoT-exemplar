...
class EAFeedbackLoopStrategy3a extends FeedbackLoop {
    ...
    private final StrategyConfigurationEAStrategy3a config;

    public EAFeedbackLoopStrategy3a(SimulationClient networkMgmt, IMoteWriter moteWriter,
            StrategyConfigurationEAStrategy3a configuration) {
