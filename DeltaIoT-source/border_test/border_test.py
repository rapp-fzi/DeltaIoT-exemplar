...
@pytest.mark.parametrize('CHANGE_POWER_VALUE', [1,  15])
def test_strategy0a(jar_file, cli_path, tmp_path, CHANGE_POWER_VALUE):
    strategy = "EAStrategy0a"
    config = {
...
@pytest.mark.parametrize('CHANGE_POWER_VALUE', [1,  15])
def test_strategy0b(jar_file, cli_path, tmp_path, CHANGE_POWER_VALUE):
    strategy = "EAStrategy0b"
    config = {
            "CHANGE_POWER_VALUE": CHANGE_POWER_VALUE,
    }
    _execute_simulator(jar_file, cli_path, strategy, config, tmp_path)
...
@pytest.mark.parametrize('CHANGE_POWER_VALUE', [1,  15])
@pytest.mark.parametrize('TIKTOK_ADAPTION', [False, True])
def test_strategy0c(jar_file, cli_path, tmp_path, CHANGE_POWER_VALUE, TIKTOK_ADAPTION):
    strategy = "EAStrategy0c"
    config = {
            "CHANGE_POWER_VALUE": CHANGE_POWER_VALUE,
            "TIKTOK_ADAPTION": TIKTOK_ADAPTION,
    }
    _execute_simulator(jar_file, cli_path, strategy, config, tmp_path)
...
@pytest.mark.parametrize('CHANGE_POWER_VALUE', [1,  15])
@pytest.mark.parametrize('TIKTOK_ADAPTION', [False, True])
@pytest.mark.parametrize('CHANGE_DIST_VALUE', [1, 100])
def test_strategy0d(jar_file, cli_path, tmp_path, CHANGE_POWER_VALUE, TIKTOK_ADAPTION, CHANGE_DIST_VALUE):
    strategy = "EAStrategy0d"
    config = {
            "CHANGE_POWER_VALUE": CHANGE_POWER_VALUE,
            "TIKTOK_ADAPTION": TIKTOK_ADAPTION,
...
@pytest.mark.parametrize('CHANGE_POWER_VALUE1', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE2', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE3', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE4', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE5', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE6', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE7', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE8', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE9', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE10', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE11', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE12', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE13', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE14', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE15', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE16', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE17', [1,  15])
def test_strategy1a(jar_file, cli_path, tmp_path,
...
#@pytest.mark.parametrize('CHANGE_POWER_VALUE16', [1,  15])
#@pytest.mark.parametrize('CHANGE_POWER_VALUE17', [1,  15])
def test_strategy1b(jar_file, cli_path, tmp_path,
                    CHANGE_POWER_VALUE1, #CHANGE_POWER_VALUE2, CHANGE_POWER_VALUE3, CHANGE_POWER_VALUE4,
                    #CHANGE_POWER_VALUE5, CHANGE_POWER_VALUE6, CHANGE_POWER_VALUE7, CHANGE_POWER_VALUE8,
                    #CHANGE_POWER_VALUE9, CHANGE_POWER_VALUE10, CHANGE_POWER_VALUE11, CHANGE_POWER_VALUE12,
                    #CHANGE_POWER_VALUE13, CHANGE_POWER_VALUE14, CHANGE_POWER_VALUE15, CHANGE_POWER_VALUE16,
...
#@pytest.mark.parametrize('CHANGE_POWER_VALUE17', [1,  15])
@pytest.mark.parametrize('TIKTOK_ADAPTION', [False, True])
def test_strategy1c(jar_file, cli_path, tmp_path,
                    CHANGE_POWER_VALUE1, #CHANGE_POWER_VALUE2, CHANGE_POWER_VALUE3, CHANGE_POWER_VALUE4,
                    #CHANGE_POWER_VALUE5, CHANGE_POWER_VALUE6, CHANGE_POWER_VALUE7, CHANGE_POWER_VALUE8,
                    #CHANGE_POWER_VALUE9, CHANGE_POWER_VALUE10, CHANGE_POWER_VALUE11, CHANGE_POWER_VALUE12,
                    #CHANGE_POWER_VALUE13, CHANGE_POWER_VALUE14, CHANGE_POWER_VALUE15, CHANGE_POWER_VALUE16,
...
@pytest.mark.parametrize('TIKTOK_ADAPTION', [False, True])
@pytest.mark.parametrize('CHANGE_DIST_VALUE', [1, 100])
def test_strategy1d(jar_file, cli_path, tmp_path,
                    CHANGE_POWER_VALUE1, #CHANGE_POWER_VALUE2, CHANGE_POWER_VALUE3, CHANGE_POWER_VALUE4,
                    #CHANGE_POWER_VALUE5, CHANGE_POWER_VALUE6, CHANGE_POWER_VALUE7, CHANGE_POWER_VALUE8,
                    #CHANGE_POWER_VALUE9, CHANGE_POWER_VALUE10, CHANGE_POWER_VALUE11, CHANGE_POWER_VALUE12,
                    #CHANGE_POWER_VALUE13, CHANGE_POWER_VALUE14, CHANGE_POWER_VALUE15, CHANGE_POWER_VALUE16,
...
#@pytest.mark.parametrize('CHANGE_POWER_VALUE17', [1,  15])
@pytest.mark.parametrize('TIKTOK_ADAPTION', [False, True])
@pytest.mark.parametrize('CHANGE_DIST_VALUE_7_8', [1, 100])
@pytest.mark.parametrize('CHANGE_DIST_VALUE_15_16', [1, 100])
@pytest.mark.parametrize('CHANGE_DIST_VALUE_5_6', [1, 100])
def test_strategy2d(jar_file, cli_path, tmp_path,
                    CHANGE_POWER_VALUE1, #CHANGE_POWER_VALUE2, CHANGE_POWER_VALUE3, CHANGE_POWER_VALUE4,
                    #CHANGE_POWER_VALUE5, CHANGE_POWER_VALUE6, CHANGE_POWER_VALUE7, CHANGE_POWER_VALUE8,
                    #CHANGE_POWER_VALUE9, CHANGE_POWER_VALUE10, CHANGE_POWER_VALUE11, CHANGE_POWER_VALUE12,
                    #CHANGE_POWER_VALUE13, CHANGE_POWER_VALUE14, CHANGE_POWER_VALUE15, CHANGE_POWER_VALUE16,
